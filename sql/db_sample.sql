...
CREATE DATABASE IF NOT EXISTS `wp` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_bin */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `wp`;
...
(
    ...
    `comment_date`         datetime(6)                                             NOT NULL COMMENT 'the date the comment was submitted. to set the date manually, $comment_date_gmt must also be specified. default is the current time',
    `comment_date_gmt`     datetime(6)                                             NOT NULL COMMENT 'the date the comment was submitted in the GMT timezone. default is $comment_date in the site''s GMT timezone',
    ...
    `gmt_modified`         datetime(6)                                             NULL     DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(6),
  ...
  ROW_FORMAT = DYNAMIC COMMENT ='the comments within blog';
...
(
    ...
    `link_updated`     datetime(6)                                             NOT NULL,
  ...
  DEFAULT CHARSET = utf8
  ROW_FORMAT = DYNAMIC COMMENT ='The wp_links holds information related to the links entered into the Links feature of WordPress. (This feature has been deprecated, but can be re-enabled with the Links Manager plugin.)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8
  ROW_FORMAT = DYNAMIC COMMENT ='The Options set under the Administration > Settings panel are stored in the wp_options table. See Option Reference for option_name and default values.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
    ...
    `post_date_gmt`         datetime(6)                                             NOT NULL,
    ...
    `post_modified`         datetime(6)                                             NOT NULL,
    `post_modified_gmt`     datetime(6)                                             NOT NULL,
  ...
  DEFAULT CHARSET = utf8
  ROW_FORMAT = DYNAMIC COMMENT ='The core of the WordPress data is the posts. It is stored in the wp_posts table. Also Pages and navigation menu items are stored in this table.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8
  ROW_FORMAT = DYNAMIC COMMENT ='Posts are associated with categories and tags from the wp_terms table and this association is maintained in the wp_term_relationships table. The association of links to their respective categories are also kept in this table.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8
  ROW_FORMAT = DYNAMIC COMMENT ='This table describes the taxonomy (category, link, or tag) for the entries in the wp_terms table.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8
  ROW_FORMAT = DYNAMIC COMMENT ='The categories for both posts and links and the tags for posts are found within the wp_terms table.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8
  ROW_FORMAT = DYNAMIC COMMENT ='The list of users';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-01-13 14:21:18
